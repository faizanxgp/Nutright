    ...
    <div class="col-md-12 ">
      ...
      <div class="portlet light bordered">
        ...
        <div class="portlet-body form">
          <form role="form" class="form-horizontal" method="post" action="{{ route('user-update') }}">
            <div class="form-body">
              ...
              <div class="form-group">
                ...
                <div class="col-md-9">
                  {{ Form::select('access_level', $userStatus, $member->access_level, ['class' => 'form-control input-inline input-medium','placeholder' => 'Select...']) }}
