...
<div class="page-sidebar-wrapper">
  ...
  <div class="page-sidebar navbar-collapse collapse">
    ...
    <ul class="page-sidebar-menu  page-header-fixed " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
      ...
      <li class="sidebar-search-wrapper">
        ...
        <form class="sidebar-search  " action="page_general_search_3.html" method="POST">
          ...
          <div class="input-group">
            ...
            <span class="input-group-btn"><a href="javascript:;" class="btn submit"><i
                    class="icon-magnifier"></i></a></span>
          </div>
        </form>
        <!-- END RESPONSIVE QUICK SEARCH FORM -->
      </li>
      
      @if( isset($user->access_level) and $user->access_level == 3)
        ...
        <li class="heading">
          <h3 class="uppercase">Features {{ $user->access_level or '-1' }}</h3>
        </li>
        <li class="nav-item  ">
        ...
        <li class="nav-item  ">
          <a href="{{ route('coupons') }}" class="nav-link nav-toggle">
            <i class="icon-diamond"></i>
      ...
      @elseif( isset($user->access_level) and $user->access_level == 2)
        <li class="nav-item start ">
          <a href="{{ route('home') }}" class="nav-link nav-toggle">
            <i class="icon-home"></i>
            <span class="title">Dashboard</span>
      ...
      @elseif( isset($user->access_level) and $user->access_level == 1)
        ...
        <li class="nav-item  ">
          <a href="{{ route('my-orders') }}" class="nav-link nav-toggle">
            <i class="icon-diamond"></i>
            <span class="title">Orders</span>
            {{--<span class="arrow"></span>--}}
          </a>
